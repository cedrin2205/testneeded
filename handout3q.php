...
<html lang="en">
  ...
  <body>
        ...
        <div class="profile-strand">
                ...
                <p class="strand">Teachers Upload 5-6</p>
            </div>
                ...
                if (mysqli_num_rows($res) > 0) {
                    while ($handout3q = mysqli_fetch_assoc($res)) { ?>
                        <div class="alb">
                            ...
                            <a class="delete-btn" href="handout3q.php?delete_image=<?=$handout3q['image_url']?>">
