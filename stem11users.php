...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["submit_update_role"])) {
        ...
        $selectedRole = "STEM"; // Set role to STEM
...
// Fetch data from the users table with role 'STEM'
$sql = "SELECT lrn, email, role FROM users WHERE role = 'STEM'";
...
<head>
    ...
    <title>Users Table (STEM)</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <link rel="stylesheet" href="admin.css">
</head>
<body>
    <div class="container mt-4">
        <h2 style="font-size: medium;">Users Table (STEM)</h2>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                ...
                                <input type='hidden' name='role' value='STEM'> <!-- Set role to STEM -->
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                            ...
                            <input type="hidden" name="role" value="STEM"> <!-- Default role to STEM -->
