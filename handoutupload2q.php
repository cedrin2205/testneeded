    ...
    if ($error === 0) {
        ...
        if (in_array($file_ex_lc, $allowed_exs)) {
            if ($img_size > 10000000000) {
                ...
                header("Location: handout2q.php?error=$em");
                exit();
            } else {
                ...
                $insertQuery = "INSERT INTO handout2q (image_url, filename) VALUES ('$new_img_name', '$img_name')";
        ...
        header("Location: handout2.php?error=$em");
        exit();
    }
}
