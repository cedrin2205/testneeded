...
<html lang="en">
  ...
  <body>
        ...
        <section>
            ...
            <div class="contain">
                <form action="handoutstem12upload.php" method="post" enctype="multipart/form-data">
            ...
            <div class="gallery">
                ...
                include "handoutdb.php";
                $limit = 15; 
                $sql = "SELECT * FROM handoutstem12 ORDER BY id DESC LIMIT $limit";
                $res = mysqli_query($conn, $sql);

                if (mysqli_num_rows($res) > 0) {
                    while ($handoutstem12 = mysqli_fetch_assoc($res)) { ?>
                        <div class="alb">
                            <?php 
                            $fileExtension = pathinfo($handoutstem12['image_url'], PATHINFO_EXTENSION);
                            if ($fileExtension === 'pdf') {
                                ...
                                echo '<img src="uploads/'.$handoutstem12['image_url'].'" alt="Uploaded Image">';
                            }
                            ?>
                            <p><?php echo $handoutstem12['filename']; ?></p>
                            <a class="delete-btn" href="handoutstem12.php?delete_image=<?=$handoutstem12['image_url']?>">
                                <img src="img/remove.png" alt="Delete" width="1" height="1">
                            </a>
                            <a class="download-btn" href="uploads/<?=$handoutstem12['image_url']?>" download="<?=$handoutstem12['image_url']?>">
