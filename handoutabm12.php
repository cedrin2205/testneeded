...
$allowedRoles = array('ABMteacher12');
...
if (isset($_GET['delete_image'])) {
    ...
    $deleteQuery = "DELETE FROM handoutabm12 WHERE image_url = '$imageToDelete'";
    if (mysqli_query($conn, $deleteQuery)) {
        if (unlink("uploads/$imageToDelete")) {
            header("Location: handoutabm12.php");
            exit();
        } else {
  ...
  <body>
        ...
        <header>
           <div class="profile-strand">
                ...
                <p class="strand">Teachers Upload ABM</p>
            </div>
        ...
        <section>
            ...
            <div class="contain">
                <form action="handoutabm12upload.php" method="post" enctype="multipart/form-data">
            ...
            <div class="gallery">
                ...
                include "handoutdb.php";
                $limit = 15; 
                $sql = "SELECT * FROM handoutabm12 ORDER BY id DESC LIMIT $limit";
                $res = mysqli_query($conn, $sql);

                if (mysqli_num_rows($res) > 0) {
                    while ($handoutabm12 = mysqli_fetch_assoc($res)) { ?>
                        <div class="alb">
                            <?php 
                            $fileExtension = pathinfo($handoutabm12['image_url'], PATHINFO_EXTENSION);
                            if ($fileExtension === 'pdf') {
                                ...
                                echo '<img src="uploads/'.$handoutabm12['image_url'].'" alt="Uploaded Image">';
                            }
                            ?>
                            <p><?php echo $handoutabm12['filename']; ?></p>
                            <a class="delete-btn" href="handoutabm12.php?delete_image=<?=$handoutabm12['image_url']?>">
                                <img src="img/remove.png" alt="Delete" width="1" height="1">
                            </a>
                            <a class="download-btn" href="uploads/<?=$handoutabm12['image_url']?>" download="<?=$handoutabm12['image_url']?>">
