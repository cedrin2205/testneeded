...
if (isset($_GET['delete_image'])) {
    ...
    $deleteQuery = "DELETE FROM handoutgas11 WHERE image_url = '$imageToDelete'";
    if (mysqli_query($conn, $deleteQuery)) {
        if (unlink("uploads/$imageToDelete")) {
            header("Location: handoutgas11.php");
            exit();
        } else {
...
<html lang="en">
  ...
  <body>
        ...
        <section>
            ...
            <div class="contain">
                <form action="handoutgas11upload.php" method="post" enctype="multipart/form-data">
                ...
                if (mysqli_num_rows($res) > 0) {
                    while ($handoutgas11 = mysqli_fetch_assoc($res)) { ?>
                        <div class="alb">
                            ...
                            <a class="delete-btn" href="handoutgas11.php?delete_image=<?=$handoutgas11['image_url']?>">
