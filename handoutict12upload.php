...
$allowedRoles = array('ICTteacher12');
    ...
    if ($error === 0) {
        ...
        if (in_array($file_ex_lc, $allowed_exs)) {
            if ($img_size > 10000000000) {
                ...
                header("Location: handoutict12.php?error=$em");
                exit();
            } else {
                ...
                $insertQuery = "INSERT INTO handoutict12 (image_url, filename) VALUES ('$new_img_name', '$img_name')";
