...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["submit_update_role"])) {
        ...
        $selectedRole = "GAS"; // Set role to GAS
...
// Fetch data from the users table with role 'GAS'
$sql = "SELECT lrn, email, role FROM users WHERE role = 'GAS'";
...
<body>
    <div class="container mt-4">
        <h2 style="font-size: medium;">Users Table (GAS)</h2>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                ...
                                <input type='hidden' name='role' value='GAS'> <!-- Set role to GAS -->
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                            ...
                            <input type="hidden" name="role" value="GAS"> <!-- Default role to GAS -->
