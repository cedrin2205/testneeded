...
$allowedRoles = array('GASteacher12');
...
if (isset($_GET['delete_image'])) {
    ...
    $deleteQuery = "DELETE FROM handoutgas12 WHERE image_url = '$imageToDelete'";
    if (mysqli_query($conn, $deleteQuery)) {
        if (unlink("uploads/$imageToDelete")) {
            header("Location: handoutgas12.php");
            exit();
        } else {
  ...
  <body>
        ...
        <header>
           <div class="profile-strand">
                ...
                <p class="strand">Teachers Upload GAS</p>
            </div>
        ...
        <section>
            ...
            <div class="contain">
                <form action="handoutgas12upload.php" method="post" enctype="multipart/form-data">
            ...
            <div class="gallery">
                ...
                include "handoutdb.php";
                $limit = 15; 
                $sql = "SELECT * FROM handoutgas12 ORDER BY id DESC LIMIT $limit";
                $res = mysqli_query($conn, $sql);

                if (mysqli_num_rows($res) > 0) {
                    while ($handoutgas12 = mysqli_fetch_assoc($res)) { ?>
                        <div class="alb">
                            <?php 
                            $fileExtension = pathinfo($handoutgas12['image_url'], PATHINFO_EXTENSION);
                            if ($fileExtension === 'pdf') {
                                ...
                                echo '<img src="uploads/'.$handoutgas12['image_url'].'" alt="Uploaded Image">';
                            }
                            ?>
                            <p><?php echo $handoutgas12['filename']; ?></p>
                            <a class="delete-btn" href="handoutgas12.php?delete_image=<?=$handoutgas12['image_url']?>">
                                <img src="img/remove.png" alt="Delete" width="1" height="1">
                            </a>
                            <a class="download-btn" href="uploads/<?=$handoutgas12['image_url']?>" download="<?=$handoutgas12['image_url']?>">
