...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["submit_update_role"])) {
        ...
        $selectedRole = "ICT"; // Set role to ICT
...
// Fetch data from the users table with role 'ICT'
$sql = "SELECT lrn, email, role FROM users WHERE role = 'ICT'";
...
<head>
    ...
    <title>Users Table (ICT)</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <link rel="stylesheet" href="admin.css">
</head>
<body>
    <div class="container mt-4">
        <h2 style="font-size: medium;">Users Table (ICT)</h2>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                ...
                                <input type='hidden' name='role' value='ICT'> <!-- Set role to ICT -->
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                            ...
                            <input type="hidden" name="role" value="ICT"> <!-- Default role to ICT -->
