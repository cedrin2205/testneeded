...
if (isset($_GET['delete_image'])) {
    ...
    $deleteQuery = "DELETE FROM handout3 WHERE image_url = '$imageToDelete'";
    if (mysqli_query($conn, $deleteQuery)) {
        if (unlink("uploads/$imageToDelete")) {
            header("Location: handout3.php");
            exit();
        } else {
...
<html lang="en">
  ...
  <body>
        ...
        <section>
            ...
            <div class="contain">
                <form action="handoutupload3.php" method="post" enctype="multipart/form-data">
                ...
                if (mysqli_num_rows($res) > 0) {
                    while ($handout3 = mysqli_fetch_assoc($res)) { ?>
                        <div class="alb">
                            ...
                            <a class="delete-btn" href="handout3.php?delete_image=<?=$handout3['image_url']?>">
