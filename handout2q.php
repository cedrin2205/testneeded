...
$roleUrls = [
    'ICTTEACHER' => ['handoutict11.php', 'ICTTEACHER11home.php'],
    'ABMTEACHER' => ['handoutabm11.php', 'ABMTEACHER11home.php'],
    'GASTEACHER' => ['handoutgas11.php', 'GASTEACHER11home.php'],
    'HUMMSTEACHER' => ['handouthumms11.php', 'HUMSS11TEACHERhome.php'],
    'STEMTEACHER' => ['handoutstem11.php', 'STEMTEACHER11home.php']
...
if (isset($_GET['delete_image'])) {
    ...
    $deleteQuery = "DELETE FROM handout2q WHERE image_url = '$imageToDelete'";
    if (mysqli_query($conn, $deleteQuery)) {
        if (unlink("uploads/$imageToDelete")) {
            header("Location: handout1q.php");
            exit();
        } else {
...
<html lang="en">
  ...
  <body>
    ...
    <ul>
        ...
        <li>
            <a href="handout1q.php" class="active">
    ...
    <div class="main-content">
      ...
      <main>
            <div class="">
              ...
              left: 400px;
              ">
                <form action="handoutupload2q.php" method="post" enctype="multipart/form-data">
            ...
            <div class="cards">
                ...
                include "handoutdb.php";
                $limit = 15; 
                $sql = "SELECT * FROM handout2q ORDER BY id DESC LIMIT $limit";
                $res = mysqli_query($conn, $sql);

                if (mysqli_num_rows($res) > 0) {
                    while ($handout2q = mysqli_fetch_assoc($res)) { ?>
                        <div class="alb">
                            <?php 
                            $fileExtension = pathinfo($handout2q['image_url'], PATHINFO_EXTENSION);
                            if ($fileExtension === 'pdf') {
                                ...
                                echo '<img src="uploads/'.$handout2q['image_url'].'" alt="Uploaded Image">';
                            }
                            ?>
                            <p><?php echo $handout2q['filename']; ?></p>
