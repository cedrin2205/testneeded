...
$roleHomePageMap = [
    ...
    'GASteacher' => 'GASTEACHER11home.php',
  ...
  <body>
        ...
        <header>
            <div class="profile-strand">
                ...
                <p class="strand">Teachers Upload 3-4</p>
            </div>
                ...
                if (mysqli_num_rows($res) > 0) {
                    while ($handout2q = mysqli_fetch_assoc($res)) { ?>
                        <div class="alb">
                            ...
                            <a class="delete-btn" href="handout2q.php?delete_image=<?=$handout2q['image_url']?>">
                                <img src="img/remove.png" alt="Delete" width="1" height="1">
                            </a>
                            <a class="download-btn" href="uploads/<?=$handout2q['image_url']?>" download="<?=$handout2q['image_url']?>">
